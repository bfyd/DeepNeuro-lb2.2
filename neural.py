...
class Perceptron:
    def __init__(self, inputSize, hiddenSizes, outputSize,hiddenSizesS):
        ...
        self.Whid = np.zeros((1 + hiddenSizes, hiddenSizesS))
        self.Whid[0, :] = np.random.randint(0, 3, size=hiddenSizesS)
        self.Whid[1:, :] = np.random.randint(-1, 2, size=(hiddenSizes, hiddenSizesS))
